    ...
    <>
      ...
      >
        <div className="flex flex-col items-start justify-around p-2 md:p-10 lg:p-20">
          ...
          <h3 className="mb-8 text-2xl lg:mb-40">Empecemos a configurar tu panel</h3>
          <div className="flex w-full gap-6 pb-10 lg:pb-20">
            ...
            />
            <Button children="Cancelar" bgType="secondary" onClick={onClose} />
          </div>
